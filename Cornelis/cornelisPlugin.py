...
from qgis.core import Qgis, QgsApplication, QgsExpressionFunction, QgsExpression
...
from .logic.typo import Typo, Typo1, TypoTree, TYPES_PAVAGES
...
class CornelisPlugin:
    ...
    def __init__(self, iface):
        ...
        self.mt = TDMapTool(self, self.iface.mapCanvas())
    ...
    def initGui(self):
        ...
        for typo1 in Typo1:
            ...
            # subButtonMenu.setToolTip(f"{TypoTree[typo1]["name"]}")
        ...
        self.actions[self.ACTION_PAVAGE_INIT].triggered.connect(lambda: self.initPavage())
        ...
        self.toolbar = self.iface.addToolBar("Cornelis")
    ...
    def unload(self):
        ...
        for action in self.actions.values():
            self.iface.removePluginMenu(self.tr("&CornelisPlugin"), action)
