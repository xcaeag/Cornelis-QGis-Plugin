...
Deux champs additionnels (cornelis_rotation, cornelis_flip) donnent la valeur de rotation (en degré) appliquée à la géométrie, et si l'image est une réflexion (flip = -1). Permet d'ajuster les styles des pictogrammes ou étiquettes.
